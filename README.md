...
```
    ...
    Frontend Container    Backend Container       
     ...
     Vite 5             WSS      YOLOv8 Custom        
     TailwindCSS                 Gemini AI 2.5        
     Nginx Alpine                Librosa              
     Port 80                     OpenCV               
       ...
       Azure Container Registry (ACR)                      
        ...
        Build e push automatizados                        
                 ...
                 Google Gemini AI 2.5 Flash API
                 (Relatórios + Transcrição)
```
 ...
 **Guia completo:** [AZURE_DEPLOYMENT_SUCCESS.md](./AZURE_DEPLOYMENT_SUCCESS.md)
...
| Recurso | Configuração | Custo Fixo | Custo 24/7 | Custo Intermitente |
|---------|--------------|-----------|------------|-------------------|
| **Azure Container Registry** | Basic | ~$5/mês | ~$5/mês | ~$5/mês |
| **Backend Container** | 1.0 vCPU, 2.0 GiB | $0 | ~$78/mês | ~$15/mês |
| **Frontend Container** | 0.5 vCPU, 1.0 GiB | $0 | ~$39/mês | ~$10/mês |
| **Log Analytics** | Primeiros 5 GB free | $0 | ~$2/mês | ~$0-2/mês |
| **TOTAL** | - | **$5/mês** | **~$124/mês** | **~$30/mês**  |

**Uso Intermitente:** Ideal para MVP acadêmico - tráfego baixo, acesso esporádico

### Como Reduzir Custos

1. **Escalar para zero quando não usar:** ~$5/mês (apenas ACR)
2. **Deletar após apresentação:** $0/mês
3. **Ligar apenas para demos:** Container inicia em ~30s quando recebe request

### Google Gemini API - Grátis

- **Gemini 2.5 Flash:** 15 RPM grátis
- **Quota mensal:** Suficiente para centenas de análises
- **Mais info:** [Google AI Pricing](https://ai.google.dev/pricing)

 **Análise completa:** [AZURE_COSTS_INFO.md](./AZURE_COSTS_INFO.md)
...
-  [**Deploy Success Guide**](./AZURE_DEPLOYMENT_SUCCESS.md) - Resolução de problemas comuns
-  [**Azure Costs Info**](./AZURE_COSTS_INFO.md) - Análise detalhada de custos
